...
; (function($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype.setExpandedState = function(node, state, options) {
		...
		if (state && node.nodes) {
			...
			node.state.expanded = true;
			if (!options.silent) {
				this.$element.trigger('nodeExpanded', $.extend(true, {},
				node));
			}
		} else if (!state) {
			...
			node.state.expanded = false;
			if (!options.silent) {
				this.$element.trigger('nodeCollapsed', $.extend(true, {},
				node));
			}
	...
	Tree.prototype.setSelectedState = function(node, state, options) {
		...
		if (state) {
			...
			if (!options.silent) {
				this.$element.trigger('nodeSelected', $.extend(true, {},
				node));
			}
		} else {
			...
			node.state.selected = false;
			if (!options.silent) {
				this.$element.trigger('nodeUnselected', $.extend(true, {},
				node));
			}
		}
	};
	...
	Tree.prototype.setCheckedState = function(node, state, options) {
		...
		if (state) {
			...
			if (!options.silent) {
				this.$element.trigger('nodeChecked', $.extend(true, {},
				node));
			}
		} else {
			...
			node.state.checked = false;
			if (!options.silent) {
				this.$element.trigger('nodeUnchecked', $.extend(true, {},
				node));
			}
		}
	};
	...
	Tree.prototype.setDisabledState = function(node, state, options) {
		...
		if (state) {
			...
			if (!options.silent) {
				this.$element.trigger('nodeDisabled', $.extend(true, {},
				node));
			}
		} else {
	...
	*/
	Tree.prototype.search = function(pattern, options) {
		options = $.extend({},
		_default.searchOptions, options);
		...
		this.$element.trigger('searchComplete', $.extend(true, {},
		results));
	...
	*/
	Tree.prototype.clearSearch = function(options) {
		...
		this.$element.trigger('searchCleared', $.extend(true, {},
		results));
	};
