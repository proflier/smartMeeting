...
public class ChineseTransPinyin {
  ...
  //将中文转换为英文
    ...
    public static void main(String[] args) throws BadHanyuPinyinOutputFormatCombination {
        System.out.println(getUpEname("张三"));
//    	chineseTransPinyin hanyuPinyinHelper = new chineseTransPinyin() ;
//      System.out.println(hanyuPinyinHelper.toHanyuPinyin("多发的发独守空房阿道夫打发第三方").toUpperCase());
