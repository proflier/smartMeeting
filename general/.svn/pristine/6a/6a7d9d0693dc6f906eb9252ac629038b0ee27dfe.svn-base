...
<%@ taglib prefix="my" uri="/WEB-INF/tlds/mytag.tld" %>
	<h4 class="page-header">会议管理>>登记信息</h4>
		...
		<div id="searchBody" class="panel-body collapse in">
			<form class="form-inline" id="searchForm">
				<div class="form-group">
			    	...
			    	<select class="form-control" id="filter_EQS_type" name="filter_EQS_type">
			    		<option value="">--选择信息类别--</option>
                        <c:forEach items="${my:findAllTemplate() }" var="template">
				...
				<div class="form-group">
			  	...
			  	<div class="form-group">
			    	...
			    	<input type="text" class="form-control" id="filter_LIKES_channel" name="filter_LIKES_channel" placeholder="渠道">
			  	</div>
	...
	<div id="toolbar" class="btn-group">
		<button type="button" class="btn btn-default" onclick="window.location.href='${ctx}/attendReg/excelOut'">
