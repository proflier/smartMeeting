 ...
 * Generated at: 2018-01-04 07:34:13 UTC
...
public final class userList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\t<h4 class=\"page-header\">系统管理>>用户管理</h4>\r\n");
      ...
      out.write("\t\t\t    \t<input type=\"text\" class=\"form-control\" id=\"\" name=\"filter_LIKES_userName\" placeholder=\"用户名\">\r\n");
      out.write("\t\t\t  \t</div>\r\n");
      out.write("\t\t\t  \t<div class=\"form-group\">\r\n");
      out.write("\t\t\t    \t<label class=\"control-label\">姓名:</label>\r\n");
      out.write("\t\t\t    \t<input type=\"text\" class=\"form-control\" id=\"\" name=\"filter_LIKES_realName\" placeholder=\"真实姓名\">\r\n");
      out.write("\t\t\t  \t</div>\r\n");
      ...
      out.write("\t\t</button>\r\n");
      out.write("\t\t<button type=\"button\" class=\"btn btn-default\" onclick=\"toUrl('toUpdatePwd');\">\r\n");
      out.write("\t\t\t<span class=\"glyphicon glyphicon-lock\" aria-hidden=\"true\"></span>修改密码\r\n");
      out.write("\t\t</button>\r\n");
      out.write("\t\t<button type=\"button\" class=\"btn btn-default\" onclick=\"toUrl('toDistributionRole');\">\r\n");
      out.write("\t\t\t<span class=\"glyphicon glyphicon-user\" aria-hidden=\"true\"></span>分配角色\r\n");
      out.write("\t\t</button>\r\n");
      out.write("\t</div>\r\n");
      ...
      out.write("/user/jsonDate?\" + $(\"#searchForm\").serialize();\r\n");
      ...
      out.write("\t\t\tcheckboxHeader : false,//设置false 将在列头隐藏check-all checkbox\r\n");
      ...
      out.write("\t\t\t\ttitle : '最后一次登录时间',\r\n");
      out.write("\t\t\t\tsortable : true\r\n");
      out.write("\t\t\t}, {\r\n");
      out.write("\t\t\t\tfield : 'status',\r\n");
      out.write("\t\t\t\ttitle : '状态',\r\n");
      out.write("\t\t\t\tformatter : function(value, row, index) {\r\n");
      out.write("\t\t\t\t\tvar returnStr = \"<div class='btn-group btn-group-sm'>\";\r\n");
      out.write("\t\t\t\t\tif (value == 1) {\r\n");
      out.write("\t\t\t\t\t\treturnStr += \"<button type='button' class='btn btn-info'>启用</button>\";\r\n");
      out.write("\t\t\t\t\t\treturnStr += \"<button type='button' class='btn btn-default' onclick='updateStatus(\" + row.id + \")'>\" + cumSpace(6) + \"</button>\";\r\n");
      out.write("\t\t\t\t\t} else {\r\n");
      out.write("\t\t\t\t\t\treturnStr += \"<button type='button' class='btn btn-default' onclick='updateStatus(\" + row.id + \")'>\" + cumSpace(6) + \"</button>\";\r\n");
      out.write("\t\t\t\t\t\treturnStr += \"<button type='button' class='btn btn-warning'>禁用</button>\";\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\treturnStr += \"</div>\";\r\n");
      ...
      out.write("\t\t$.get('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/toCreate', function(data) {\r\n");
      out.write("\t\t\t$(\"#myModal\").html(data);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$('#myModal').modal('show');\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\tfunction toUrl(name) {\r\n");
      out.write("\t\tvar jsonArray = dataTable.bootstrapTable('getSelections');\r\n");
      out.write("\t\tif (jsonArray.length == 0) {\r\n");
      out.write("\t\t\talert(\"请选择一条数据\");\r\n");
      out.write("\t\t\treturn false;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\t$.get('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/' + name + '/' + jsonArray[0].id, function(data) {\r\n");
      out.write("\t\t\t$(\"#myModal\").html(data);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$('#myModal').modal('show');\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t$.get('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/toUpdate/' + action + '/' + id, function(data) {\r\n");
      out.write("\t\t\t$(\"#myModal\").html(data);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t\t$('#myModal').modal('show');\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t$.get('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/updateStatus/' + id, function(data) {\r\n");
      ...
      out.write("\t\t$.get('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/user/delete/' + delId, function(data) {\r\n");
      out.write("\t\t\tif (data == \"success\") {\r\n");
      out.write("\t\t\t\tcx();\r\n");
