...
<!-- 			<p style="text-align:center"><button type="button" id="upload">自定义上传按钮</button></p> -->
		...
		function fullAvatarEditor() {
			...
			var file			= '${ctx}/static/others/fullAvatar/fullAvatarEditor.swf';		//flash文件的路径
			var	version			= "10.1.0";						//播放该flash所需的最低版本
			var	expressInstall	= '${ctx}/static/others/fullAvatar/expressInstall.swf';			//expressInstall.swf的路径
            ...
            swfobject.addDomLoadEvent(function () {
                var swf = new fullAvatarEditor("swfContainer", {
					    id: 'swf',
						upload_url: '${ctx}/staffInfor/avatarUpload/${currentPid}',
						src_upload:2,
...
// 									alert(msg.content.sourceUrl)
									$("#imgAra").attr("src", "${ctx}/staffInfor/avatarView/"+msg.content.sourceUrl);  
									$('#myModalChild').hide();
								}
							break;
						}
