	...
	<div class="main" id="main">
		...
		<div class="sg_layout vm_share vm_detail">
			...
			<div class="card_wrapper card_image">
				...
				<div sg-view="" class="vm_cardphoto">
					...
					<div class="card_wrap">
						...
						<div class="items">
							<div class="items_inner">
								...
								<div class="img"> 
									<img class="img_inner" src="${ctx }/vistor/toUserCard/${staffInfor.id }.png" style=" margin-top: -2.13333px; margin-left: 0px; visibility: visible;">
								</div>
							</div>
						</div>
					...
					<div onclick="hiddeImg()" id="full_img_wrapper" class="full_img_wrapper" style="display: none;">
						<div class="imgs_mask "
							...
							<div class="img_wrapper" style="width: 100%;">
								<img class="full_img" src="${ctx }/vistor/toUserCard/${staffInfor.id }"
								style="width: 482px; height: 267.108px; margin-left: 0px; margin-top: 100px; visibility: visible;">
							</div>
						</div>
					</div>
